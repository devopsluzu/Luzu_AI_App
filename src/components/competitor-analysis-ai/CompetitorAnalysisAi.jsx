...
const sanitizeKeys = (obj) => {
  ...
  return (
    ...
    <div className={styles.competitorAnalysisContainer}>
      <h1 className={styles.competitorAnalysisContainerHeading}>Competitor Analysis</h1>
      ...
      <div className={styles.competitorAnalysisSearch}>
        ...
        <div className={styles.competitorAnalysisSearchInput}>
          ...
          <div
            className={`${styles.competitorAnalysisSearchInputButton} ${loading ? styles.loading : ""}`}
