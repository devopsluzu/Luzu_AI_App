  ...
  return (
    ...
    {popupOpen && (
      <div className={styles.chatInputUpgrade}>
        ...
        <p>There are currently no prompts left. Prompts will reset after 24 hours.</p>
        <Link href='/pricing' ><button>Upgrade</button></Link>
        <RiCloseFill className={styles.chatInputUpgradeClose} onClick={() => setPopupOpen(false)} style={{color:"var(--p-color)"}}/>
        </div>
      </div>
     )} 
    ...
    <div className={styles.chatInputContainer}>
      ...
      />
      <div 
        className={`${styles.chatInputGenerateButton} ${isTyping ? styles.loading : ""}`} 
        style={{ backgroundColor: buttonHl ? 'var(--black-white)' : 'var(--black-white)', height:"100%" }}
        onClick={handleSendMessage}
      >
        <p>Generate</p>
