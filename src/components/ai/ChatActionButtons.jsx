...
<div className={styles.chatActionButtons}>
      <div className={styles.chatActionButtonsLeft}>
          <div className={styles.filterChatButton} onClick={handleFilterButtonClick}>
            <Image src={filter} height={19} alt='filter'/>
          </div>
      </div>
      <div className={styles.chatActionButtonsRight}>
          <div className={styles.copyChatButton} onClick={() => {setIsCopied(!isCopied); handleCopyChat()}} onMouseEnter={() => setCopyHover(true)} onMouseLeave={() => setCopyHover(false)}>
            <Image src={copy} height={14} alt='copy'/>
          ...
          <div className={styles.refreshChatButton} onClick={handleRefreshContent}>
            <Image src={refresh} height={13} alt='refresh'/>
          </div>
      </div>
    </div>
    {formattedContent && <div className={styles.chatActionButtonsMobile}>
      <div className={styles.chatActionButtonsLeft}>
      </div>
      <div className={styles.chatActionButtonsRight}>
      <div className={styles.copyChatButton} onClick={() => {setIsCopied(!isCopied); handleCopyChat()}} onMouseEnter={() => setCopyHover(true)} onMouseLeave={() => setCopyHover(false)}>
